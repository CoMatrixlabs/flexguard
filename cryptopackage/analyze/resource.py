...
def analyze_resource(source=None, *, steps, **options):
    """Analyze resource

    API      | Usage
    -------- | --------
    Public   | `from frictionless import analyze_resource`
    ...
    for step in steps:
        ...
        # Transform
        try:
            step.analyze_resource(resource)
